    ...
    <div>
      <div className="card" style={{ padding: '20px 24px', marginBottom: 20, background: '#fffbeb', border: '1px solid #fef3c7' }}>
        <div style={{ display: 'flex', gap: 14, alignItems: 'flex-start' }}>
          <div style={{ width: 36, height: 36, borderRadius: '50%', background: '#fef3c7', color: '#b45309', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, fontSize: 18, fontWeight: 700 }}>
            🛡️
          </div>
          <div>
