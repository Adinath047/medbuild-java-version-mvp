        ...
        >
          {activeTab === 'privacy' ? (
            <div>
              ...
              <p>
                Medicos Hospital EMR collects patient demographic data, clinical encounters, diagnostic reports, vitals, and prescription history. All Electronic Health Records (EHR) are encrypted in transit using TLS 1.3 and at rest using AES-256 standards.
              </p>
            ...
            <div>
              ...
              <p>
                Digital prescriptions, lab orders, and discharge summaries issued through Medicos EMR are generated by licensed healthcare practitioners. Printed slips are valid legal prescriptions when accompanied by doctor registration credentials or signature.
              </p>
              ...
              <p>
                Medicos EMR utilizes offline-first local cache synchronization to guarantee uninterrupted clinical workflows even during internet outages.
              </p>
            </div>
          )}
        </div>
